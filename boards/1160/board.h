...
#define BOARD_DEBUG_UART_CLK_FREQ 24000000
	...
	#define BOARD_UART_TX_PIN         IOMUXC_GPIO_LPSR_04_LPUART11_TXD
	#define BOARD_UART_RX_PIN         IOMUXC_GPIO_LPSR_05_LPUART11_RXD
...
static const clock_root_t LPUART_Clock [] = 
{
	(clock_root_t)0xFFFF,	// Invalid
	kCLOCK_Root_Lpuart1,
	kCLOCK_Root_Lpuart2,
	kCLOCK_Root_Lpuart3,
	kCLOCK_Root_Lpuart4,
...
#if EXAMPLE_CAN_INDEX == 1
	#define EXAMPLE_CAN CAN1
	#define BOARD_CAN_TX_PIN         IOMUXC_GPIO_AD_06_FLEXCAN1_TX
	#define BOARD_CAN_RX_PIN         IOMUXC_GPIO_AD_07_FLEXCAN1_RX
	#define BOARD_CAN_CLOCK_SOURCE   kCLOCK_Root_Can1
#elif EXAMPLE_CAN_INDEX == 2
	#define EXAMPLE_CAN CAN2
	#define BOARD_CAN_TX_PIN         IOMUXC_GPIO_AD_01_FLEXCAN2_RX
	#define BOARD_CAN_RX_PIN         IOMUXC_GPIO_AD_00_FLEXCAN2_TX
	#define BOARD_CAN_CLOCK_SOURCE   kCLOCK_Root_Can2
#elif EXAMPLE_CAN_INDEX == 3
	#define EXAMPLE_CAN CAN3
	#define BOARD_CAN_TX_PIN         IOMUXC_GPIO_LPSR_00_FLEXCAN3_TX
	#define BOARD_CAN_RX_PIN         IOMUXC_GPIO_LPSR_01_FLEXCAN3_RX
	#define BOARD_CAN_CLOCK_SOURCE   kCLOCK_Root_Can3
#else
	#error "Unsupported CAN"
#endif
