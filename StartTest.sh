...
Path_Crossworks="C:\Program Files\Rowley CrossWorks for ARM 5.4.2\bin\crossworks.exe"
...
##	"GCC_OPTIONS=\"### O3 LTO ###\"|\"Level 3\"|link_time_optimization=Yes"
##	"GCC_OPTIONS=\"### O3 ###\"|\"Level 3\"|"
#	"GCC_OPTIONS=\"###_O2_###\"|\"Level 2\"|"
#	"GCC_OPTIONS=\"###_O1_###\"|\"Level 1\"|"
#	"GCC_OPTIONS=\"###_O0_###\"|\"Level 0\"|"
#	"GCC_OPTIONS=\"###_Debug_###\"|\"Debug\"|"
#	"GCC_OPTIONS=\"###_Optimize_For_Size_###\"|\"Optimize For Size\"|"
#)


declare -a CompilerProfiles=(
#	"GCC_OPTIONS=\"###_O3_###\"|Level 3|"
	"GCC_OPTIONS=\"###_O2_###\"|Level 2|"
	"GCC_OPTIONS=\"###_O1_###\"|Level 1|"
	"GCC_OPTIONS=\"###_O0_###\"|Level 0|"
	"GCC_OPTIONS=\"###_Debug_###\"|Debug|"
...
for ProjectName in "${SelectedProjects[@]}"; do
	for CompilerProfile in "${CompilerProfiles[@]}"; do
		...
		if [ -n "$LinkTimeOptimization" ]; then
			BuildArgs+=( -sproperty link_time_optimization=\"$LinkTimeOptimization\" )
		fi

		BuildArgs+=( "$SolutionFile" )

		echo "Build Projekt: $ProjectName with compiler-options: $ProfileName"
		echo "$Path_Crossbuild ${BuildArgs[*]}"
		"$Path_Crossbuild" "${BuildArgs[@]}" "$SolutionFile"

		echo "Lade Projekt auf das Ziel: $ProjectName"
#		"$Path_Crossload" -quiet -target "CMSIS-DAP" -solution "$SolutionFile" -project "$ProjectName" -config Release

		echo -e "\033[45m Press any key to continue...\033[0m"
		read -n 1 -s -r
	done
done