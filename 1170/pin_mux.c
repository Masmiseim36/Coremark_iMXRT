...
void BOARD_InitPins(void)
{
	...
	IOMUXC_SetPinMux(
	  ...
	  0U);                                    /* Software Input On Field: Input Path is determined by functionality */
	IOMUXC_SetPinMux(
	  BOARD_CAN_TX_PIN,        /* GPIO_LPSR_00 is configured as FLEXCAN3_TX */
	  1U);                                    /* Software Input On Field: Force input path of pad GPIO_LPSR_00 */
	IOMUXC_SetPinMux(
	  BOARD_CAN_RX_PIN,        /* GPIO_LPSR_01 is configured as FLEXCAN3_RX */
	...
	IOMUXC_SetPinConfig(
	  ...
	  0x06U);                                 /* Slew Rate Field: Slow Slew Rate
												 ...
												 Open Drain Field: Disabled */
	IOMUXC_SetPinConfig(
	  BOARD_CAN_TX_PIN,        /* GPIO_LPSR_00 PAD functional properties : */
	...
	IOMUXC_SetPinConfig(
	  BOARD_CAN_RX_PIN,        /* GPIO_LPSR_01 PAD functional properties : */
	  0x02U);                                 /* Slew Rate Field: Slow Slew Rate
												 Drive Strength Field: high driver
												 Pull / Keep Select Field: Keeper
												 Pull Up / Down Config. Field: Weak pull down
